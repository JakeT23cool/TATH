...
print("Welcome to JakeT23's TAT bot - For Educational Purposes only.")
if exists("answers.json") != True:
    ...
    print("Notice - Always use a flag")
#url = input("url: ")
...
if flag == "a":
    topicjson = json.loads(requests.post("https://www.testandtrack.io/index.php/profile/getQuizByTopic/"+TopicID, headers=HEADERS).text) # Safeguard
    ids = []
    for xy in topicjson:
